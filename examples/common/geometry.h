...
static const MopVertex PLANE_VERTICES[] = {
    { .position = { -5, 0, -5 }, .normal = { 0, 1, 0 }, .color = { 0.5f, 0.5f, 0.5f, 1 } },
    { .position = {  5, 0, -5 }, .normal = { 0, 1, 0 }, .color = { 0.5f, 0.5f, 0.5f, 1 } },
    { .position = {  5, 0,  5 }, .normal = { 0, 1, 0 }, .color = { 0.5f, 0.5f, 0.5f, 1 } },
    { .position = { -5, 0,  5 }, .normal = { 0, 1, 0 }, .color = { 0.5f, 0.5f, 0.5f, 1 } },
};
...
static inline uint32_t geometry_make_sphere(
    int lat, int lon, float radius,
    MopVertex *out_verts, uint32_t *out_indices,
    MopColor color)
{
    uint32_t vi = 0;
    for (int i = 0; i <= lat; i++) {
        ...
        for (int j = 0; j <= lon; j++) {
            ...
            out_verts[vi].position = (MopVec3){ n.x * radius, n.y * radius, n.z * radius };
...
static inline bool write_ppm(const char *path, const uint8_t *pixels,
