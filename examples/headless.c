...
static const MopVertex CUBE_VERTICES[] = {
    /* Front face (Z+) — red */
    { .position = { -0.5f, -0.5f,  0.5f }, .normal = {  0.0f,  0.0f,  1.0f }, .color = { 0.9f, 0.2f, 0.2f, 1.0f } },
    { .position = {  0.5f, -0.5f,  0.5f }, .normal = {  0.0f,  0.0f,  1.0f }, .color = { 0.9f, 0.2f, 0.2f, 1.0f } },
    { .position = {  0.5f,  0.5f,  0.5f }, .normal = {  0.0f,  0.0f,  1.0f }, .color = { 0.9f, 0.2f, 0.2f, 1.0f } },
    { .position = { -0.5f,  0.5f,  0.5f }, .normal = {  0.0f,  0.0f,  1.0f }, .color = { 0.9f, 0.2f, 0.2f, 1.0f } },

    /* Back face (Z-) — green */
    { .position = {  0.5f, -0.5f, -0.5f }, .normal = {  0.0f,  0.0f, -1.0f }, .color = { 0.2f, 0.9f, 0.2f, 1.0f } },
    { .position = { -0.5f, -0.5f, -0.5f }, .normal = {  0.0f,  0.0f, -1.0f }, .color = { 0.2f, 0.9f, 0.2f, 1.0f } },
    { .position = { -0.5f,  0.5f, -0.5f }, .normal = {  0.0f,  0.0f, -1.0f }, .color = { 0.2f, 0.9f, 0.2f, 1.0f } },
    { .position = {  0.5f,  0.5f, -0.5f }, .normal = {  0.0f,  0.0f, -1.0f }, .color = { 0.2f, 0.9f, 0.2f, 1.0f } },

    /* Top face (Y+) — blue */
    { .position = { -0.5f,  0.5f,  0.5f }, .normal = {  0.0f,  1.0f,  0.0f }, .color = { 0.2f, 0.2f, 0.9f, 1.0f } },
    { .position = {  0.5f,  0.5f,  0.5f }, .normal = {  0.0f,  1.0f,  0.0f }, .color = { 0.2f, 0.2f, 0.9f, 1.0f } },
    { .position = {  0.5f,  0.5f, -0.5f }, .normal = {  0.0f,  1.0f,  0.0f }, .color = { 0.2f, 0.2f, 0.9f, 1.0f } },
    { .position = { -0.5f,  0.5f, -0.5f }, .normal = {  0.0f,  1.0f,  0.0f }, .color = { 0.2f, 0.2f, 0.9f, 1.0f } },

    /* Bottom face (Y-) — yellow */
    { .position = { -0.5f, -0.5f, -0.5f }, .normal = {  0.0f, -1.0f,  0.0f }, .color = { 0.9f, 0.9f, 0.2f, 1.0f } },
    { .position = {  0.5f, -0.5f, -0.5f }, .normal = {  0.0f, -1.0f,  0.0f }, .color = { 0.9f, 0.9f, 0.2f, 1.0f } },
    { .position = {  0.5f, -0.5f,  0.5f }, .normal = {  0.0f, -1.0f,  0.0f }, .color = { 0.9f, 0.9f, 0.2f, 1.0f } },
    { .position = { -0.5f, -0.5f,  0.5f }, .normal = {  0.0f, -1.0f,  0.0f }, .color = { 0.9f, 0.9f, 0.2f, 1.0f } },

    /* Right face (X+) — cyan */
    { .position = {  0.5f, -0.5f,  0.5f }, .normal = {  1.0f,  0.0f,  0.0f }, .color = { 0.2f, 0.9f, 0.9f, 1.0f } },
    { .position = {  0.5f, -0.5f, -0.5f }, .normal = {  1.0f,  0.0f,  0.0f }, .color = { 0.2f, 0.9f, 0.9f, 1.0f } },
    { .position = {  0.5f,  0.5f, -0.5f }, .normal = {  1.0f,  0.0f,  0.0f }, .color = { 0.2f, 0.9f, 0.9f, 1.0f } },
    { .position = {  0.5f,  0.5f,  0.5f }, .normal = {  1.0f,  0.0f,  0.0f }, .color = { 0.2f, 0.9f, 0.9f, 1.0f } },

    /* Left face (X-) — magenta */
    { .position = { -0.5f, -0.5f, -0.5f }, .normal = { -1.0f,  0.0f,  0.0f }, .color = { 0.9f, 0.2f, 0.9f, 1.0f } },
    { .position = { -0.5f, -0.5f,  0.5f }, .normal = { -1.0f,  0.0f,  0.0f }, .color = { 0.9f, 0.2f, 0.9f, 1.0f } },
    { .position = { -0.5f,  0.5f,  0.5f }, .normal = { -1.0f,  0.0f,  0.0f }, .color = { 0.9f, 0.2f, 0.9f, 1.0f } },
    { .position = { -0.5f,  0.5f, -0.5f }, .normal = { -1.0f,  0.0f,  0.0f }, .color = { 0.9f, 0.2f, 0.9f, 1.0f } },
};
...
static bool write_ppm(const char *path, const uint8_t *pixels,
