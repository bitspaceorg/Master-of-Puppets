...
static void test_custom_overlay_registration(void) {
    ...
    uint32_t handle = mop_viewport_add_overlay(vp, "test_overlay",
                                                custom_overlay_fn, NULL);
...
static void test_custom_overlay_invoked(void) {
    ...
    uint32_t handle = mop_viewport_add_overlay(vp, "counter",
                                                custom_overlay_fn, NULL);
    TEST_ASSERT(handle != UINT32_MAX);
...
static void test_wireframe_overlay_render(void) {
    ...
    MopMeshDesc desc = {
        .vertices = verts, .vertex_count = 3,
        .indices = indices, .index_count = 3,
        .object_id = 1
    };
