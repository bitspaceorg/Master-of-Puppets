...
int main(int argc, char *argv[]) {
    ...
    printf("Loaded %s: %u vertices, %u indices (%u triangles)\n",
           input, obj.vertex_count, obj.index_count, obj.index_count / 3);
    ...
    printf("Written %s (%u bytes header + %u bytes vertices + %u bytes indices)\n",
           output,
           MOP_HEADER_SIZE,
           (uint32_t)(obj.vertex_count * sizeof(MopVertex)),
