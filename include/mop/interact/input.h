...
#ifndef MOP_INTERACT_INPUT_H
#define MOP_INTERACT_INPUT_H
...
typedef enum MopInputType {
  ...
  MOP_INPUT_SCROLL,
  MOP_INPUT_SCROLL_ORBIT, /* two-finger trackpad scroll → orbit */
  ...
  /* Edit mode switching */
  MOP_INPUT_EDIT_MODE_NONE,
  MOP_INPUT_EDIT_MODE_VERTEX,
  MOP_INPUT_EDIT_MODE_EDGE,
  MOP_INPUT_EDIT_MODE_FACE,
} MopInputType;
...
typedef enum MopEventType {
  ...
  MOP_EVENT_EDIT_MODE_CHANGED,
  MOP_EVENT_ELEMENT_SELECTED,
  MOP_EVENT_ELEMENT_DESELECTED,
} MopEventType;
