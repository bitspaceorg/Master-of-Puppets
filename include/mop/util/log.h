...
#ifndef MOP_UTIL_LOG_H
#define MOP_UTIL_LOG_H
...
typedef void (*MopLogCallback)(MopLogLevel level, const char *file, int line,
...
#define MOP_DEBUG(...)                                                         \
  mop_log_emit(MOP_LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__)
#else
...
#define MOP_INFO(...)                                                          \
  mop_log_emit(MOP_LOG_INFO, __FILE__, __LINE__, __VA_ARGS__)
#else
...
#define MOP_WARN(...)                                                          \
  mop_log_emit(MOP_LOG_WARN, __FILE__, __LINE__, __VA_ARGS__)
#else
