...
static uint32_t light_index_from_id(uint32_t id) {
    return id - 0xFFFE0000u;
}
    ...
    case MOP_INPUT_POINTER_MOVE: {
        ...
        case MOP_INTERACT_GIZMO_DRAG: {
            ...
            if (is_light_indicator(vp->selected_id)) {
                ...
                if (li >= MOP_MAX_LIGHTS || !vp->lights[li].active) break;
                ...
                if (light->type == MOP_LIGHT_DIRECTIONAL) {
                    ...
                    MopVec3 cur_pos = mop_vec3_add(vp->cam_target,
                                                    mop_vec3_scale(cur_dir, 3.0f));
                    ...
                    MopVec3 snapped = mop_vec3_add(vp->cam_target,
