...
static const char *level_str(MopLogLevel level) {
    switch (level) {
        case MOP_LOG_DEBUG: return "DEBUG";
        case MOP_LOG_INFO:  return "INFO ";
        case MOP_LOG_WARN:  return "WARN ";
        case MOP_LOG_ERROR: return "ERROR";
        default:            return "?????";
    }
}

static void default_callback(MopLogLevel level, const char *file,
